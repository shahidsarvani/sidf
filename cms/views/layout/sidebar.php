  ...
  <div class="sidebar-content">
    ...
    <div class="sidebar-user-material">
      <div class="sidebar-user-material-body">
        <div class="card-body text-center"> <a href="#"> <img src="<?php echo ADMIN_ASSET ?>/global_assets/images/placeholders/placeholder.jpg" class="img-fluid rounded-circle shadow-1 mb-3" width="80" height="80" alt=""> </a>
          ...
          <span class="font-size-sm text-white text-shadow-dark"><?php echo $_SESSION['user_email']; ?></span> </div>
      ...
      <div class="collapse" id="user-nav">
        <ul class="nav nav-sidebar">
          <!-- <li class="nav-item"> <a href="#" class="nav-link"> i class="icon-user-plus"></i> <span>My profile</span> </a> </li> -->
    ...
    <div class="card card-sidebar-mobile">
      <ul class="nav nav-sidebar" data-nav-type="accordion">
        ...
        <li class="nav-item"> <a href="<?php echo ADMIN_SITE_URL.'/controller/dashboard.php' ?>" class="nav-link" id="navlink-dashboard"> <i class="icon-home4"></i> <span> Dashboard </span> </a> </li>
        ...
        <li class="nav-item nav-item-submenu" id="navlink-sections"> <a href="#" class="nav-link"> <i class="icon-grid"></i> <span> Sections </span></a>
          <ul class="nav nav-group-sub" data-submenu-title="Sections">
            ...
            <!-- <li class="nav-item">
				<a href="<?php echo ADMIN_SITE_URL.'/controller/sections/add.php' ?>" class="nav-link" id="navlink-timelineItems_add">Add Timeline Item</a>
			</li> -->
          </ul>
        </li>
