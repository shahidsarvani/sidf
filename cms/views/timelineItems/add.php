        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header header-elements-inline">
                    <h5 class="card-title">Add Timeline Item</h5>
                </div>

                <div class="card-body">
                    <form action="<?php echo ADMIN_SITE_URL . '/controller/timelineItems/add.php' ?>" method="post" enctype="multipart/form-data" id="screen-form">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Item Title:</label>
                                    <input type="text" name="title" class="form-control" placeholder="1978" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="text_eng" class="form-control" id="text_eng" cols="30" rows="3"></textarea>
                        </div>
                        <div class="form-group">
