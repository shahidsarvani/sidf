...
foreach ($tokens as $index => $value) {
    ...
    // }
    $temp .= '<div class="col-6 d-flex align-items-center justify-content-center flex-column next_tab" data-slug="' . $value['slug'] . '" data-loader_name="' . $items_config['rfid_loadermedia_url'] . $loader_video['name'] . '" data-loader_type="' . $loader_video['filetype'] . '">
