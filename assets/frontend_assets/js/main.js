...
$(document).ready(function () {
  ...
  for (var ci = 0; ci < pulsatingCircles.length; ci++) {
    pulsatingCircles[ci].addEventListener('touchstart', function (e) {
  ...
  for (var i = 0; i < closeModal.length; i++) {
    closeModal[i].addEventListener('touchstart', function () {
      var _this = $(this);
  ...
  for(var i = 0; i < readMoreLinks.length; i++) {
    ...
    readMoreLinks[i].addEventListener('touchstart', function (e) {
  ...
  function modalOpened(modal) {
    ...
    $('#' + modal.id + ' .close-modal').on('touchstart', function () {
      clearInterval(interval);
    })
